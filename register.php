        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-5">
                  ...
                  <form action="registerController.php" class="login-form" method="post">
                            ...
                            <div class="form-group d-flex">
                                <input type="password" class="form-control rounded-left"
                                    placeholder=" confirmed Password" name="comPassword" required>
                            </div>
                            <div class="form-group">
                                <button type="submit"name="register" id="register"
                                    class="btn btn-primary rounded submit p-3 px-5">Get Started</button>
                            </div>
                        </form>
                    </div>
                </div>
